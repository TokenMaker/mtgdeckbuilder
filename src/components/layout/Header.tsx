...
export function Header({ onSave, onExport, onMyDecks, onLogin, onClearDeck }: HeaderProps) {
    ...
    <header className="fixed top-0 left-0 right-0 z-40 bg-zinc-950/95 backdrop-blur border-b border-zinc-800 h-14 flex items-center px-4 gap-3">
      ...
      <div className="flex items-center gap-1.5 flex-shrink-0">
        ...
        {isConfigured ? (
          ...
          <div className="flex items-center gap-1.5 px-2 py-1.5 text-xs text-zinc-600 rounded-lg" title="Auth not configured">
            <User size={15} />
          </div>
        )}
      </div>
